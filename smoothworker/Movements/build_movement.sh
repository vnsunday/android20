...
echo ${OPENCV_CMD}
g++ movement2D.cpp -o movement2D $(pkg-config --cflags --libs opencv4) -I${OPENCV_INCLUDE} -L${OPENCV_LIB_PATH} -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs  -Wl,-rpath,"${OPENCV_BIN_PATH}"